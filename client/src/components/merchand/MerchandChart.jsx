...
export default function AdminChart(props) {
    ...
    const dataPieChart = [
        { name: 'Transactions validés', value: props.value[1] }, { name: 'Transactions en cours de validation', value: props.value[0] },
            ...
            <div className={"container row"}>
                ...
                <PieChart width={400} height={400}>
                    <Pie dataKey="value" isAnimationActive={false} data={dataPieChart} cx={200} cy={200} outerRadius={80} label>
                        ...
                        <Tooltip />
                        <Legend>Transactions en attente / Transactions validés</Legend>
                </PieChart>
            </div>
